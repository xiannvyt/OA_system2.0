...
-- ----------------------------
-- Table structure for oa_dept_power
-- ----------------------------
DROP TABLE IF EXISTS `oa_dept_power`;
CREATE TABLE `oa_dept_power` (
  ...
  CONSTRAINT `oa_dept_power_ibfk_1` FOREIGN KEY (`menu_id`) REFERENCES `oa_menu` (`menu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限部门';

-- ----------------------------
-- Records of oa_dept_power
-- ----------------------------
...
-- ----------------------------
-- Table structure for oa_emp_bian
-- ----------------------------
DROP TABLE IF EXISTS `oa_emp_bian`;
CREATE TABLE `oa_emp_bian` (
  ...
  CONSTRAINT `FK_emp_bian` FOREIGN KEY (`pay_standardid`) REFERENCES `oa_salaryitme` (`pay_standardid`),
...
-- ----------------------------
-- Records of oa_emp_bian
-- ----------------------------

-- ----------------------------
-- Table structure for oa_emp_paiban
-- ----------------------------
DROP TABLE IF EXISTS `oa_emp_paiban`;
CREATE TABLE `oa_emp_paiban` (
  `emp_id` varchar(20) NOT NULL COMMENT '工号',
...
-- ----------------------------
-- Records of oa_emp_paiban
-- ----------------------------
INSERT INTO `oa_emp_paiban` VALUES ('emp2018001', 'sht2018001');
INSERT INTO `oa_emp_paiban` VALUES ('emp2018002', 'sht2018001');
INSERT INTO `oa_emp_paiban` VALUES ('emp2018003', 'sht2018001');
INSERT INTO `oa_emp_paiban` VALUES ('emp2018004', 'sht2018001');
INSERT INTO `oa_emp_paiban` VALUES ('emp2018005', 'sht2018001');
INSERT INTO `oa_emp_paiban` VALUES ('emp2018006', 'sht2018001');
INSERT INTO `oa_emp_paiban` VALUES ('emp2018007', 'sht2018001');
...
-- ----------------------------
INSERT INTO `oa_password` VALUES ('emp2018001', '123456');
...
CREATE TABLE `oa_role` (
  `role_id` int(255) NOT NULL AUTO_INCREMENT COMMENT '角色编号',
...
-- ----------------------------
-- Table structure for oa_role_emp
-- ----------------------------
DROP TABLE IF EXISTS `oa_role_emp`;
CREATE TABLE `oa_role_emp` (
  `role_id` int(11) NOT NULL COMMENT '角色编号',
  `emp_id` varchar(20) NOT NULL COMMENT '员工编号',
  PRIMARY KEY (`role_id`,`emp_id`),
  KEY `fk_role_emp_emp_id` (`emp_id`),
  CONSTRAINT `fk_role_emp_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `oa_emp` (`emp_id`),
  CONSTRAINT `fk_role_emp_role_id` FOREIGN KEY (`role_id`) REFERENCES `oa_role` (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色员工分配表';

-- ----------------------------
-- Records of oa_role_emp
-- ----------------------------
...
CREATE TABLE `oa_role_menu` (
  `role_id` int(11) NOT NULL COMMENT '角色编号',
  `menu_id` int(11) NOT NULL COMMENT '权限编号',
  PRIMARY KEY (`role_id`,`menu_id`),
  KEY `fk_role_menu_menu_id` (`menu_id`),
  CONSTRAINT `fk_role_menu_menu_id` FOREIGN KEY (`menu_id`) REFERENCES `oa_menu` (`menu_id`),
  CONSTRAINT `fk_role_menu_role_id` FOREIGN KEY (`role_id`) REFERENCES `oa_role` (`role_id`)
...
-- ----------------------------
-- Table structure for oa_salaryitme
-- ----------------------------
DROP TABLE IF EXISTS `oa_salaryitme`;
CREATE TABLE `oa_salaryitme` (
  `pay_standardid` varchar(10) NOT NULL COMMENT '薪资标准编号',
  `pay_standardtype` varchar(10) DEFAULT NULL COMMENT '薪资标准类型',
  `pay_standardname` varchar(20) DEFAULT NULL COMMENT '薪资标准名称',
  `pay_standardvalue` varchar(50) DEFAULT NULL COMMENT '薪资标准初始值或公式',
  `pay_standardstatus` varchar(2) DEFAULT NULL COMMENT '薪资标准状态',
  PRIMARY KEY (`pay_standardid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='薪资标准表';

-- ----------------------------
-- Records of oa_salaryitme
-- ----------------------------
INSERT INTO `oa_salaryitme` VALUES ('001', '初始值', '基本工资', '2500', '1');
INSERT INTO `oa_salaryitme` VALUES ('002', '系统提取值', '迟到', '-50', '1');
INSERT INTO `oa_salaryitme` VALUES ('003', '系统提取值', '旷工', '-200', '1');
INSERT INTO `oa_salaryitme` VALUES ('004', '系统提取值', '早退', '-50', '1');
INSERT INTO `oa_salaryitme` VALUES ('005', '初始值', '全勤奖', '200', '1');

-- ----------------------------
-- Table structure for oa_salaryrecord
-- ----------------------------
DROP TABLE IF EXISTS `oa_salaryrecord`;
CREATE TABLE `oa_salaryrecord` (
...
-- ----------------------------
-- Records of oa_salaryrecord
-- ----------------------------

-- ----------------------------
-- Table structure for oa_salaryselect
-- ----------------------------
DROP TABLE IF EXISTS `oa_salaryselect`;
CREATE TABLE `oa_salaryselect` (
  `pay_salarytypeid` varchar(20) DEFAULT NULL COMMENT '薪资模板编号',
  `pay_salarytypeemp` varchar(20) DEFAULT NULL COMMENT '使用薪资模板员工编号',
  KEY `pay_salarytype` (`pay_salarytypeid`),
  KEY `pay_salaryemp` (`pay_salarytypeemp`),
  CONSTRAINT `pay_salaryemp` FOREIGN KEY (`pay_salarytypeemp`) REFERENCES `oa_emp` (`emp_id`),
  CONSTRAINT `pay_salarytype` FOREIGN KEY (`pay_salarytypeid`) REFERENCES `oa_salarytype` (`pay_salarytypeid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工工资模板分配表';

-- ----------------------------
-- Records of oa_salaryselect
-- ----------------------------
INSERT INTO `oa_salaryselect` VALUES ('001', 'emp2018003');
INSERT INTO `oa_salaryselect` VALUES ('001', 'emp2018002');

-- ----------------------------
-- Table structure for oa_salarytype
-- ----------------------------
DROP TABLE IF EXISTS `oa_salarytype`;
CREATE TABLE `oa_salarytype` (
  `pay_salarytypeid` varchar(20) NOT NULL DEFAULT '' COMMENT '薪资模板编号',
  `pay_salarytypename` varchar(50) DEFAULT NULL COMMENT '薪资模板名称',
  `pay_salarytypecreaterid` varchar(20) DEFAULT NULL COMMENT '薪资模板创建人id',
  `pay_salarytypecreatedate` date DEFAULT NULL COMMENT '薪资模板创建日期',
  `pay_salarytyperemark` varchar(200) DEFAULT NULL COMMENT '薪资模板备注',
  `pay_salarytypestatus` varchar(2) DEFAULT NULL COMMENT '薪资模板状态',
  PRIMARY KEY (`pay_salarytypeid`),
  KEY `FK_createrid` (`pay_salarytypecreaterid`),
  CONSTRAINT `FK_createrid` FOREIGN KEY (`pay_salarytypecreaterid`) REFERENCES `oa_emp` (`emp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='工资模板表';

-- ----------------------------
-- Records of oa_salarytype
-- ----------------------------
INSERT INTO `oa_salarytype` VALUES ('001', '普通员工工资模板', 'emp2018001', '2018-01-09', '测试数据', '1');
...
-- ----------------------------
-- Table structure for oa_trainstu
-- ----------------------------
DROP TABLE IF EXISTS `oa_trainstu`;
CREATE TABLE `oa_trainstu` (
  `rp_id` varchar(20) NOT NULL COMMENT '培训计划编号',
  `emp_id` varchar(20) NOT NULL COMMENT '工号',
