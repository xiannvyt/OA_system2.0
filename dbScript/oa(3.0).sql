...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='权限部门';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='标准员工';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工排班';
...
CREATE TABLE `oa_balance` (
  ...
  PRIMARY KEY (`bal_id`),
  KEY `FK_caozuo` (`caozuo_id`),
  KEY `FK_emper` (`baler_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='加班结余表';
...
CREATE TABLE `oa_cardborrow` (
  ...
  PRIMARY KEY (`cb_id`),
  KEY `FK_bo_emp` (`emp_id`),
  KEY `FK_card_bo` (`card_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='证件借阅表';
...
CREATE TABLE `oa_examtask` (
  ...
  PRIMARY KEY (`et_id`),
  KEY `FK_temp_task` (`pt_id`),
  CONSTRAINT `FK_temp_task` FOREIGN KEY (`pt_id`) REFERENCES `oa_pertemp` (`pt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考核任务表';
...
CREATE TABLE `oa_formal` (
  ...
  PRIMARY KEY (`for_id`),
  KEY `FK_emp_formal` (`emp_id`),
  CONSTRAINT `FK_emp_formal` FOREIGN KEY (`emp_id`) REFERENCES `oa_emp` (`emp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='转正表';
...
CREATE TABLE `oa_leave` (
  ...
  PRIMARY KEY (`lea_id`),
  KEY `FK_emp_levac` (`emp_id`),
  KEY `FK_vac_type` (`vac_id`),
...
CREATE TABLE `oa_move` (
  ...
  PRIMARY KEY (`move_id`),
  KEY `FK_emp_move` (`emp_id`),
  KEY `FK_move_dept` (`dept_id`),
  KEY `FK_move_job` (`job_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='人事调动表';
...
CREATE TABLE `oa_overtimecode` (
  ...
  PRIMARY KEY (`type_id`,`emp_id`),
  KEY `FK_emp_jia` (`emp_id`),
  KEY `FK_type_add` (`type_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工加班记录表';
...
CREATE TABLE `oa_overtimetype` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='加班类型表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='薪资标准表';
...
CREATE TABLE `oa_paytable` (
  ...
  PRIMARY KEY (`pay_id`),
  KEY `FK_emp_send` (`emp_id`),
  CONSTRAINT `FK_emp_send` FOREIGN KEY (`emp_id`) REFERENCES `oa_emp` (`emp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='薪资发放表';
...
CREATE TABLE `oa_paytemplate` (
  ...
  KEY `FK_creater` (`oa__emp_id`),
  KEY `FK_examer` (`oa__emp_id2`),
  KEY `FK_sender` (`emp_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='薪资模版表';
...
CREATE TABLE `oa_personalbook` (
  ...
  PRIMARY KEY (`per_id`),
  KEY `FK_per_emp` (`emp_id`),
  CONSTRAINT `FK_per_emp` FOREIGN KEY (`emp_id`) REFERENCES `oa_emp` (`emp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个人通讯录表';
...
CREATE TABLE `oa_pertemp` (
  ...
  PRIMARY KEY (`pt_id`),
  KEY `FK_emp_temp` (`emp_id`),
  KEY `FK_job_temp` (`job_id`),
...
CREATE TABLE `oa_rap` (
  ...
  PRIMARY KEY (`rap_id`),
  KEY `FK_apply` (`raper_id`),
  KEY `FK_emp_rap` (`apply_id`),
...
CREATE TABLE `oa_schedulecontent` (
  ...
  `sch_id` varchar(20) DEFAULT NULL COMMENT '日程编号',
  `con_type` int(11) DEFAULT NULL COMMENT '日程员工类型',
  ...
  PRIMARY KEY (`con_cid`),
  KEY `FK_content_sch` (`sch_id`),
  CONSTRAINT `FK_content_sch` FOREIGN KEY (`sch_id`) REFERENCES `oa_schedule` (`sch_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='日程内容表';
...
CREATE TABLE `oa_scheduletype` (
  ...
  PRIMARY KEY (`sht_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='排班类型表';
...
CREATE TABLE `oa_score` (
  ...
  KEY `FK_emp_score` (`emp_id`),
  KEY `FK_task_score` (`et_id`),
...
CREATE TABLE `oa_scoredetail` (
  ...
  PRIMARY KEY (`sd_id`),
  KEY `FK_pro_detail` (`ep_id`),
  KEY `FK_score_detail` (`score_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='评分明细表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='通讯录分组表';
...
CREATE TABLE `oa_traintec` (
  ...
  PRIMARY KEY (`tec_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训讲师表';
...
CREATE TABLE `oa_turn` (
  ...
  PRIMARY KEY (`turn_id`),
  KEY `FK_flow_turn` (`flow_id`),
  CONSTRAINT `FK_flow_turn` FOREIGN KEY (`flow_id`) REFERENCES `oa_flow` (`flow_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='转办记录表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训学员';
