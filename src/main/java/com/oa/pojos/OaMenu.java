...
public class OaMenu implements Serializable {
	...
	public OaMenu(int fatherId, String img, int isVisable, String link, String name) {
		this.menuFather=fatherId;
		this.menuImg=img;
		this.menuIsvisible=isVisable;
		this.menuLink=link;
		this.meuName=name;
	}
	
	public OaMenu(int id,int fid,String img,int isable,String link,String name){
		this.menuFather=fid;
		this.menuImg=img;
		this.menuIsvisible=isable;
		this.menuLink=link;
		this.meuName=name;
		this.menuId=id;
	}
